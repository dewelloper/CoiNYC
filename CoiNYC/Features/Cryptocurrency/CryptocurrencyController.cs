...
namespace CoiNYC.Features.Cryptocurrency
{
    ...
    public class CryptocurrencyController : BaseController
    {
        ...
        public CryptocurrencyController(IHttpClientFactory httpClientFactory, ISitemapService sitemapService, IMediator mediator, ICurrencyService currency, ICacheService cache)
