namespace CoiNYC.Services
{
    ...
    public class ManifestService : IManifestService
    {
        ...
        public ManifestService(UrlHelper urlHelper, IWebHostEnvironment env)
        {
        ...
        public string GetManifestJson()
        {
            JObject document = new JObject(
                new JProperty("short_name", _env.ApplicationName),
                new JProperty("name", _env.ApplicationName),
                new JProperty("icons",
                    new JArray(
                        GetIconJObject("~/css/icons/android-chrome-36x36.png", "36x36", "image/png", "0.75"),
                        GetIconJObject("~/css/icons/android-chrome-48x48.png", "48x48", "image/png", "1.0"),
                        GetIconJObject("~/css/icons/android-chrome-72x72.png", "72x72", "image/png", "1.5"),
                        GetIconJObject("~/css/icons/android-chrome-96x96.png", "96x96", "image/png", "2.0"),
                        GetIconJObject("~/css/icons/android-chrome-144x144.png", "144x144", "image/png", "3.0"),
                        GetIconJObject("~/css/icons/android-chrome-192x192.png", "192x192", "image/png", "4.0"))));
