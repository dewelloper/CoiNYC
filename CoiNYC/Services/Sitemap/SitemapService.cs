namespace CoiNYC.Services
{
    ...
    public class SitemapService : SitemapGenerator, ISitemapService
    {
        ...
        //private readonly IUrlService urlHelper;
        ...
        protected virtual IReadOnlyCollection<SitemapNode> GetSitemapNodes()
        {
            ...
            //nodes.Add(
            //    new SitemapNode(this.urlHelper.GetHelper().AbsoluteAction("Index", "Home"))
            //    {
            //        Priority = 1
            //    });
            //nodes.Add(
            //   new SitemapNode(this.urlHelper.GetHelper().AbsoluteAction("About", "Home"))
            //   {
            //       Priority = 0.9
            //   });
            //nodes.Add(
            //   new SitemapNode(this.urlHelper.GetHelper().AbsoluteAction("Contact", "Home"))
            //   {
            //       Priority = 0.9
            //   });
        ...
        {
            //return this.urlHelper.GetHelper().AbsoluteAction("GetSitemapXml", "Home").TrimEnd('/') + "?index=" + index;
            return "url_service_err";
        }
